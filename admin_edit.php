<?php 
    ...
    $user_data = query("SELECT * FROM users WHERE id = '{$_GET['id']}'");
    // var_dump($user_data);
...
<body class="bg-image">
    ...
    <nav class="navbar navbar-dark d-flex row justify-content-center">
        <h1 style="text-align: center;width:100%;color:white;letter-spacing:3px" class="col-lg-4">Edit user</h1>
    </nav>
    <div class="container-fluid px-3 py-5 mx-auto" style="width:520px;border-radius:10px; height:fit-content; background-color: rgba(255,255,255,.8)">
        ...
        <form action="" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <input type="text" name="username" class="form-control" id="inputUsername" value="<?= $user_data[0]["username"] ?>" readonly>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <input type="password" name="password" class="form-control" id="inputPassword3" readonly>
                </div>
            </div>
